...
export class PetaPageComponent implements AfterViewInit, OnDestroy {
  ...
  @Input() banjarList: BanjarDinas[] = [
    ...
    },
    {
      ...
      products: ['Padi', 'Kopi Arabika', 'Lemon', 'Alpukat', 'Jeruk Siam', 'Bunga Gemitir'],
    ...
    },
    {
      ...
      products: ['Asparagus','Kopi Arabika', 'Durian Kane', 'Bunga Gemitir'],
    ...
    },
    {
      ...
      products: ['Asparagus', 'Padi', 'Kopi Arabika', 'Durian Kane', 'Cabai Rawit', 'Bunga Gemitir'],
    ...
    },
    {
      ...
      products: ['Asparagus', 'Kopi Arabika', 'Durian Kane', 'Alpukat', 'Jeruk Siam', 'Bunga Gemitir'],
    ...
    },
    {
      ...
      products: ['Asparagus', 'Padi', 'Kopi Arabika'],
